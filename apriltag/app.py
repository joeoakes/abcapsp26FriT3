...
from apriltag_grid_map import CameraTracker
import time, cv2, numpy as np

app = Flask(__name__)

try:
    tracker = CameraTracker(cam_index=0)
    print("[INFO] CameraTracker started on index 0")
...
if __name__ == '__main__':
    print("AprilTag camera streamer — port 5001")
    try:
